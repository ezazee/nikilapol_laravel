            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!--RD Navbar Brand-->
                  <div class="rd-navbar-brand">@foreach ($whitelabel as $whitelabel )
                    <!--Brand--><a class="brand" href="/"><img class="brand-logo-dark" src="/image/{{$whitelabel->logo}}" alt="" width="140" height="45"/><img class="brand-logo-light" src="/image/{{$whitelabel->logo}}" alt="Marketplace Asli Lamongan" width="140"/></a>
                  </div>@endforeach
                </div>
                <div class="rd-navbar-main-element">
                  ...
                  <div class="rd-navbar-collapse">
                    <a class="button button-secondary button-nuka" href="#">Belanja Sekarang<span class="button-overlay"></span></a>
                  </div>
                  </ul>
                </div>
              </div>
