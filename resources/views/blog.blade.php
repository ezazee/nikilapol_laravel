      ...
      <div class="slides">
        ...
        <article class="main-post main-post--active">
          <div class="main-post__image">
            <img src="/image/{{$artikel->gambar}}" alt="New McLaren wind tunnel 'critical' to future performance, says Tech Director Key" />
          </div>
            ...
            <div class="o-row--slider__col-3 c-list-grid-item">
              <a href="../bantuan/akun/blog/blog_akun.html">
                ...
                <div class="mt-auto col-12 row justify-content-between">
                  <span class="c-blog-highlight__date-large">Niki Anterin / {{ $blog->created_at }}</span>
                </div>
              </a>
            </div>
            @endforeach
